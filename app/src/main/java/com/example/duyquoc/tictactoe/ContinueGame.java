...
public class ContinueGame extends Activity {
    ...
    private void initializeGame() {
        try {
            Scanner scan = new Scanner(openFileInput("save.txt"));
            String line;
            if (scan.hasNextLine()) {
                line = scan.nextLine();
    ...
    public void displayInitialize() {
        ...
        String[][] theBoard = board.getBoard();
